...
% This function rotates, translates and scales a 3D pointcloud "source" 
% of N*3 size (N points in N rows, 3 collumns for XYZ)
% to fit a similar shaped point cloud "target" again of N by 3 size
% 
% The output shows the minimized value of dissimilarity measure in "error",
% the transformed source data set and the transformation,
% rotation, scaling and translation in 
% transform.T, transform.b and transform.c such that
